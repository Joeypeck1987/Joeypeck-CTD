...
let temps = [0, 10, 25, 37, 100];

for (let celsiusTemp of temps) {
    console.log("Q1 convertTemp:", celsiusTemp, convertTemp(celsiusTemp));
}
// ---------- QUESTION 2 ----------
...
let testStrings = ["HelloWorld", "JavaScript", "Joey", ""];

for (let inputString of testStrings) {
    console.log("Q2 reverseString:", inputString, reverseString(inputString));
}
// ---------- QUESTION 3 ----------
...
let testNumbers = [0, 1, 2, 3, 4, 5, 12, 17, 20];

for (let number of testNumbers) {
    console.log("Q6 is Prime:", number, isPrime(number));
}
...
let primeTests = [5, 10, 13, 20];

for (let number of primeTests) {
...
let scores2 = [100, 95, 88, 92];
let scores3 = [50, -10, 120, 70];
let scores4 = [];
let scores5 = [-5, 200, 300];
...
console.log("Q8 calculateAverage:", calculateAverage(scores4));
console.log("Q8 calculateAverage:", calculateAverage(scores5));
...
console.log("Q9 getLetterGrade(95):", getLetterGrade(95));
...
function printClassResult(className, student, scores) {
    ...
    return `${className} - Student: ${student}, Average: ${average}, Grade: ${grade}, Passed: ${passed(grade) ? "yes" : "no"}`;
}
